...
text = re.sub(r'<p class=border>.*?</p>', '', text, flags=re.DOTALL|re.IGNORECASE)
...
with open('/home/jo/biblioteca-universal-arion/obres/filosofia/lucreci/de-rerum-natura-llibre-i/original.md', 'w') as f:
    ...
    f.write('**Autor:** Titus Lucretius Carus (c. 99–55 aC)\n\n')
    f.write('**Font:** [The Latin Library](https://www.thelatinlibrary.com/lucretius/lucretius1.shtml)\n\n')
    f.write('**Llengua:** llatí\n\n')
    f.write('---\n\n')
    prev_empty = False
    for line in lines:
        if not line:
